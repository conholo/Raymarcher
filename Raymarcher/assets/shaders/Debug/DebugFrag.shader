...
float DE_TestFractal(vec4 position)
{
	vec4 o = position;
	float d = 1e20;
	BoxFold(position, vec3(0.340000, 0.340000, 0.340000));
	MengerFold(position);
	RotationYFold(position, 1.000000, -0.000000);
	position *= 2.000000;
	position.xyz += vec3(-6.270000, -1.500000, 0.000000);
	RotationXFold(position, 0.342020, 0.939693);
	BoxFold(position, vec3(0.340000, 0.340000, 0.340000));
	MengerFold(position);
	RotationYFold(position, 1.000000, -0.000000);
	position *= 2.000000;
	...
	position.xyz += vec3(-6.270000, -1.500000, 0.000000);
	RotationXFold(position, 0.342020, 0.939693);
	d = min(d, DE_Box(position - vec4(vec3(0.000000, 0.000000, 0.000000), 0.0), vec3(3.000000, 3.000000, 3.000000)));
	return d;
}
vec4 CE_TestFractal(vec4 position)
{
	...
	MengerFold(position);
	RotationYFold(position, 1.000000, -0.000000);
	orbit = min(orbit, abs((position.xyz - vec3(0.000000, 0.000000, 0.000000)) * vec3(1.000000, 1.000000, 1.000000)));
	position *= 2.000000;
	position.xyz += vec3(-6.270000, -1.500000, 0.000000);
	RotationXFold(position, 0.342020, 0.939693);
	orbit = max(orbit, abs(position.xyz - vec3(0.000000, 0.000000, 0.000000)) * vec3(0.420000, 0.380000, 0.190000));
	BoxFold(position, vec3(0.340000, 0.340000, 0.340000));
	MengerFold(position);
	RotationYFold(position, 1.000000, -0.000000);
	orbit = min(orbit, abs((position.xyz - vec3(0.000000, 0.000000, 0.000000)) * vec3(1.000000, 1.000000, 1.000000)));
	...
	RotationXFold(position, 0.342020, 0.939693);
	orbit = max(orbit, abs(position.xyz - vec3(0.000000, 0.000000, 0.000000)) * vec3(0.420000, 0.380000, 0.190000));
	newColor = vec4(orbit, DE_Box(position - vec4(vec3(0.000000, 0.000000, 0.000000), 0.0), vec3(3.000000, 3.000000, 3.000000)));
